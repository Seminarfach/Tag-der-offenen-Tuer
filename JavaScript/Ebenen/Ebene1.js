...
export const schulhofConfig = {
    ...
    dialog: {
        text: "Willkommen auf dem Schulhof!<br>Begebe dich nun zum Haupteingang.",
        show: true,
    },
...
export const Flur1Config = {
    ...
    dialog: {
        text: "Willkommen auf im 300er Flur <br> Begebe dich nun zum Raum 2.",
        show: true,
    },
    blockMovementUntilContinue: true, 
...
dialog: {
    text: "Willkommen auf im Matheraum 305! <br> Begebe dich nun zur Tafel, um das Rätsel zu starten.",
    show: true,
},
ui: { title: false, interface: false, moving: false },
};
